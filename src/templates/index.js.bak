...
const IndexPage = ({ data, pathContext }) => {
  ...
  return (
      ...
      <div className="home-template">
        ...
        <Header image='https://www.xemgame.com/data/pictures/img//2016414/19deb53a1f1f7b7f408331a0bc15758e/111-1460629900.png' title="Đà Lạt quê tôi" tagline="Romantic mountain and driver.." />
